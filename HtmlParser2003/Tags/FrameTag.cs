// ***************************************************************
//  FrameTag   version:  1.0   date: 12/18/2005
//  -------------------------------------------------------------
//  
//  -------------------------------------------------------------
...
{
	/// <summary> Identifies a frame tag</summary>
	[Serializable]
	public class FrameTag:TagNode
	{
		/// <summary> The set of names handled by this tag.</summary>
		private static readonly System.String[] mIds = new System.String[]{"FRAME"};

		/// <summary> Create a new frame tag.</summary>
		public FrameTag()
		{
		}
		...
		{
			return "FRAME TAG : Frame " + FrameName + " at " + FrameLocation + "; begins at : " + StartPosition + "; ends at : " + EndPosition;
		}
	}
}
