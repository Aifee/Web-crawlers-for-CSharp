// ***************************************************************
//  Bullet   version:  1.0   date: 12/18/2005
//  -------------------------------------------------------------
//  
//  -------------------------------------------------------------
...
{
	/// <summary> A bullet tag.</summary>
	[Serializable]
	public class Bullet:CompositeTag
	{
		/// <summary> The set of names handled by this tag.</summary>
		private static readonly System.String[] mIds = new System.String[]{"LI"};
		
		/// <summary> The set of end tag names that indicate the end of this tag.</summary>
		private static readonly System.String[] mEndTagEnders = new System.String[]{"UL", "OL", "BODY", "HTML"};
